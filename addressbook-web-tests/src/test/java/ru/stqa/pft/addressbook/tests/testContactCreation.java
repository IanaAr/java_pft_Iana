...
public class testContactCreation {
  ...
  public void testContactCreation() throws Exception {
    returnToContactCreationPage();
    fillContactForm(new ContactData("Test", "Test", "Test", "Test", "Title", "Company", "Address", "1111111", "9111111111", "922222222", "1111111", "qw@qw.qw", "qw@qw.qw", "qw@qw.qw"));
    sendContactForm();
  }
  ...
  private void returnToContactCreationPage() {
